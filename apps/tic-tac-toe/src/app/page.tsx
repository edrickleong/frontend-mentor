...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-dark-navy px-6">
      ...
      <button className="mt-4 w-full rounded-2xl bg-light-blue pb-6 pt-4 text-center text-base font-bold uppercase tracking-wider text-dark-navy shadow-[0_-8px_0_0_#118C87_inset] hover:bg-light-blue-hover">
        New game (vs player)
      </button>
    </main>
  )
