...
export function OIcon(props: ComponentProps<"svg">) {
  return (
...
export function OIconOutline(props: ComponentProps<"svg">) {
  return (
...
export function XIconOutline(props: ComponentProps<"svg">) {
  return (
    <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
